...
app.get('/semantic-forms/:siteId/form/:formId', async function(req, res) {
  const siteId = req.params["siteId"];
  const formId = req.params["formId"];

  try {
    const bundle = await retrieveForm(siteId, formId);
...
app.put('/semantic-forms/:siteId/form/:formId', async function(req, res) {
